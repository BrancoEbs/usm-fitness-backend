...
SECRET_KEY = 'django-insecure-clave-de-rescate-temporal'
DEBUG = True
ALLOWED_HOSTS = ['*'] # Permite la conexión desde tu tablet Samsung
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': "Ingresa tu token con el prefijo 'Bearer '"
        }
    }
}
